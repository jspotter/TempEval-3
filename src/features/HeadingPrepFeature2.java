...
public class HeadingPrepFeature2 implements TempEvalFeature {
	...
	/*
	 * This is a copy of Garrett's HeadingPrepFeature with the token order switched.
	 */
	@Override
	public void add(List<String> features, CoreLabel token2, CoreLabel token1) {
